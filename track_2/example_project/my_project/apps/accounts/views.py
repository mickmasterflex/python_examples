...
from common import generic as common_generic
...
class ListUsersView(accounts_mixins.LoginRequiredMixin,
    ...
    def get_context_data(self, **kwargs):
        ...
        context['letters'] = common_utils.first_letters(self.object_list,
                'first_name')
        return context
...
class EditUserView(accounts_mixins.LoginRequiredMixin,
                   accounts_mixins.PermissionsRequiredMixin,
                   common_generic.CreateUpdateView):
    permissions_required = constants.PERMISSIONS_SES_STAFF_AND_ABOVE
    ...
    def send_email(self):
        password = common_utils.generate_random_value(
...
class EditMyUserView(accounts_mixins.LoginRequiredMixin,
                     common_generic.CreateUpdateView):
