...
class MyProjectTestSuiteRunner(NoseTestSuiteRunner):
    """
    Runs testing suite and adds code coverage report.
    """
    def __init__(self, *args, **kwargs):
        super(MyProjectTestSuiteRunner, self).__init__(*args, **kwargs)
        self.coverage = coverage.coverage()
        self.coverage.use_cache(0) # don't use caching with coverage.py

    def build_suite(self, *args, **kwargs):
        suite=super(MyProjectTestSuiteRunner, self).build_suite(*args,
                **kwargs)
    ...
    def run_tests(self, test_labels, extra_tests=None, **kwargs):
        ...
        test_results = super(MyProjectTestSuiteRunner, self)\
